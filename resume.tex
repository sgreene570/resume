...
\begin{compactdesc}
    ...
    \item[Operating Systems] \begin{inparaenum} {Linux: Debian, RHEL, Fedora} \end{inparaenum}
    \item[Technologies] \begin{inparaenum} {OpenShift, Splunk, PostgreSQL, MySQL, Git, GitHub, Vim} \end{inparaenum}
\end{compactdesc}
...
Manage Linux systems for a computing focused living-learning community.  Maintain OpenShift cluster for deploying member projects.
