...
\section{SKILLS}
\begin{compactdesc}
    \item[Languages] \begin{inparaenum} {Go, C, Python} \end{inparaenum}
    \item[Operating Systems] \begin{inparaenum} {Linux: Debian, Fedora, Red Hat / Fedora Core OS} \end{inparaenum}
