...
\section{SKILLS}
\begin{compactdesc}
    \item[Languages] \begin{inparaenum} {Python, C, Golang, Java, \LaTeX, Bash} \end{inparaenum}
    \item[Operating Systems] \begin{inparaenum} {Linux: Debian, Ubuntu, RHEL} \end{inparaenum}
    \item[Technologies] \begin{inparaenum} {Ansible, Openshift, PostgreSQL, MySQL, Git, Neovim} \end{inparaenum}
\end{compactdesc}

\section{EXPERIENCE}
{\bf \large{Software Engineering Co-op}} \hfill January 2018 - Present \\
{\bf Intuit Inc, Mountain View, CA} \hfill \url{https://www.intuit.com} \\
Full time developer working on the first time user experience for Quickbooks Online Accountant.
\\
\\
...
who use CSH provided services for working on technical projects.  Ceph, Proxmox,
Openshift, mail, LDAP/FreeIPA, and database services are provided to all members.
