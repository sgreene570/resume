...
Uses a Jinja2 templated front end to display and retrieve audio files.
\\
\\
...
time employees to maintain uptime and meet deadlines.  Used department wide version control to develop automation solutions and documentation. \\
...
work closely to maximize uptime and maintain the integrity of a class B network.
