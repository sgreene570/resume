...
Ncurses based terminal audio file sequencer and player.  Written in C using Pthreads and ALSA libraries.  Interprets WAV type files
with user defined pitch control.
